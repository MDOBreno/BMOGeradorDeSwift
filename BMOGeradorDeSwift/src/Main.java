...
public class Main {
	...
	static String dataclass = "Evento{nome:String, data: String, local: String, descricao: String, imagem: String}";
	...
	public static void main(String[] args) throws IOException {
		...
		Entity entidade = DSLGrammarRecognizer(dataclass);
	...
	private static Entity DSLGrammarRecognizer(String entrada) {
